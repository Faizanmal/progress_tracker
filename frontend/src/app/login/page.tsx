...
import { MotionDiv, FadeUp } from "@/src/lib/motion";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex gradient-mesh overflow-hidden">
      {/* Decorative Elements */}
        ...
        <FadeUp delay={0.1}>
          <div className="max-w-md">
            <div className="flex items-center gap-3 mb-8">
              <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-violet-500 flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-primary/30">
                PT
              </div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              The all-in-one platform to manage your team&apos;s progress with powerful analytics and real-time insights.
            </p>
